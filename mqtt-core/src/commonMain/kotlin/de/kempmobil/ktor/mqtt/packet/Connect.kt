...
public data class Connect(
    ...
    init {
        wellFormedWhen((willMessage != null) || (willQoS == QoS.AT_MOST_ONCE)) {
    ...
    override fun toString(): String {
        ...
        return "Connect(isCleanStart=$isCleanStart, willMessage=$willMessage, willQoS=$willQoS, retainWillMessage=$retainWillMessage, " +
...
private val Connect.bits: Byte
    get() {
        ...
        if (willMessage != null) {
            ...
            bits = (bits or 4) or (willQoS.value shl 3)
